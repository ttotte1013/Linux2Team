"""
=============================================================
  quiz.py  ─  팀원 B (문시연) 담당 섹션
  역할: 레벨별 문제 출제 / 정답 채점 / 점수 계산 / 권장 단어장 추천
  담당 라우트: /level  /quiz  /submit
  ※ 팀원 C 담당 라우트(/wrongnote, /retry)는 이 파일 하단에
    섹션 구분선을 두고 C가 이어서 작성합니다.
=============================================================
"""
...
#    팀원 D가 main.html을 담당하지만, Flask 라우트는 여기서 열어줍니다.
# ------------------------------------------------------------------
@app.route("/")
def index():
...
# ==================================================================
#  ▼▼▼  팀원 C 담당 구역 (오답 노트 / 재시험) — 아래에 이어서 작성  ▼▼▼
# ==================================================================
