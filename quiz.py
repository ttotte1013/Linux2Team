...
# ------------------------------------------------------------------
# 1. 레벨 선택  POST /level
#    프론트(main.html)에서 선택한 레벨·모드를 세션에 저장하고 퀴즈 페이지로 리다이렉트
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 2. 문제 출제  GET /quiz
#    세션의 level·mode를 읽어 DB에서 단어를 무작위로 꺼내 4지선다 JSON을 반환.
# ------------------------------------------------------------------
...
def get_quiz():
    ...
    # [오답 구현 연동] 오답 재시험 모드일 때는 오답 전용 출제 로직으로 연결
...
def result():
    ...
    # 사용자가 10문제 중 8문제(80%) 이상 맞췄을 때 실전 토익 안내 링크를 제공
    # ==================================================================
